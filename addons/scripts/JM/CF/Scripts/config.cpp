...
class CfgMods
{
	class JM_CommunityFramework
	{
		...
		extra = 0;
		type = "mod";
		defines[] = {"CF_MODULE_CONFIG","CF_EXPRESSION","CF_TRACE_STACK_NAME_ASSUMPTION_FIX","CF_GHOSTICONS","CF_MODSTORAGE_DISABLE","CF_MODSTORAGE_MODULE_DISABLE","CF_SURFACES","CF_MODULES","CF_REF_FIX","CF_BUGFIX_REF"};
